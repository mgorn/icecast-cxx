...
- [`stream-api.md`](stream-api.md) — listener/publisher semantic models, reconnect/state, backpressure, publisher writes, and ICY framing.
- [`transport-curl.md`](transport-curl.md) — implemented native listener transport and libcurl-specific invariants.
- [`publish-libshout.md`](publish-libshout.md) — implemented native publisher and libshout-specific invariants.
